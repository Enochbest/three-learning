...
//创建点光源绑定小球
const pointBall  = new THREE.Mesh(
    new THREE.SphereGeometry(0.1,20,20),
    new THREE.MeshBasicMaterial( { color:0xff0000 } )
)

pointBall.position.set(2,2,2)
...
//设置点光源安装距离衰减量 renderer.physicallyCorrectLights = true 需要在物理渲染模式下进行
pointLight.decay = 0
...
function render() {
    ...
    pointBall.position.y = 2 + Math.sin(time*10) * 3
    //阻尼效果更新
    controls.update();
